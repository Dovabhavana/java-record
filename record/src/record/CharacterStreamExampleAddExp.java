package record;
import java.io.*;
public class CharacterStreamExampleAddExp {

	public static void main(String[] args)  throws IOException {
		// TODO Auto-generated method stub
		  File file = new File("C:\\Users\\BHAVANA\\Documents\\bhavana.txt");
	      FileReader reader = new FileReader(file);
	      char chars[] = new char[(int) file.length()];
	 
	      reader.read(chars);
	      File out = new File("C:\\Users\\BHAVANA\\Documents\\bhavana.txt");
	     ...
	     String s="2-cse-a: 2020-2024";
	      ...
	      BufferedWriter bw=new BufferedWriter(new FileWriter("C:\\Users\\BHAVANA\\Documents\\bhavana.txt"));
	      bw.write(s);
	      bw.close();
	      br.close();
